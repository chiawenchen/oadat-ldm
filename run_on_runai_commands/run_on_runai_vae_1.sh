...
python train_vae_aekl.py --oadat_dir /mydata/dlbirhoui/firat/OADAT --num_epochs 250 --gpus 1 --batch_size 128 --num_workers 4 --job_name aekl_small_kl --mix_swfd_scd
