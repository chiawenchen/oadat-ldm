...
img_top = Image.open("dm_f=500_b=500_seed=42_denoised_1.png")
img_bottom = Image.open("dm_f=500_b=500_seed=42_denoised_2.png")
...
combined_image.save("dm_f=500_b=500_seed=42_denoised.png")
