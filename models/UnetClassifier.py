# Reference: https://www.kaggle.com/code/vikramsandu/guided-diffusion-by-openai-from-scratch/notebook#Unet-Architecture
import torch
...
class UnetAttentionClassifier(LightningModule):
    def __init__(self,
        ...
        super(UnetAttentionClassifier, self).__init__()
        ...
        num_swfd = 36426
        num_scd = 8003
        class_weights = torch.tensor([num_swfd, num_scd], dtype=torch.float32)
